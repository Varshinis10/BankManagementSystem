    ...
    public void actionPerformed(ActionEvent ae){
        ...
        try{
            if(ae.getSource()==b1){
                ...
                if(atype.equals(""))
                {
                    JOptionPane.showMessageDialog(null, "Fill all the required fields");//to give a warning that the field is empty
                }
                else
                {
                    Conn c1 = new Conn();
                    ...
                    c1.s.executeUpdate(q1);//to update the information in the database
